...
$yy = substr($date_prof,6,4);
$mm = substr($date_prof,3,2);
$dd = substr($date_prof,0,2);
$date_prof_db = $yy.'-'.$mm.'-'.$dd;
$time_prof_db = $time_prof.':00';
/* составить запрос для вставки информации о данных в таблицу */ 
$query = "INSERT INTO $userstable VALUES(0, $date_prof_db, '00:01:02', $timest,($reactive_prof/2), ($active_prof/2))";
