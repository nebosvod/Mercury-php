...
function crc16($string,$length=0){
	...
	if (strlen(dechex($uchCRCLo)) == 1)
		{
		$uchCRCLo_str = "0".(dechex($uchCRCLo));
		}
		else
		{
		$uchCRCLo_str = dechex($uchCRCLo);
		}
		
		
	if (strlen(dechex($uchCRCHi)) == 1)
		{
		$uchCRCHi_str = "0".(dechex($uchCRCHi));
		}
		else
		{
		$uchCRCHi_str = dechex($uchCRCHi);
		}
    $res = strtoupper($uchCRCLo_str.$uchCRCHi_str);
return $res;
